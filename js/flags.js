...
function displayQuestion(i) {
    i = index; 
    const url = "https://mtn-gaming.herokuapp.com/flags";
    fetch(url)
        .then(response => response.json())
        .then(data => {
            if (i <= 9) {
                document.getElementById("reference-question").innerHTML = `Image N°${data[i].id}`;
                document.getElementById("indice-fr").innerHTML = data[i].indice_fr;
                document.getElementById("indice-en").innerHTML = `(${data[i].indice_en})`;
                document.getElementById("question").src = data[i].flag_q;
                ...
                document.getElementById("indice-fr").innerHTML = "";
                document.getElementById("indice-en").innerHTML = "";
...
function displayAnswer() {
    ...
    fetch(url)
        .then(response => response.json())
        .then(data => {   
            document.getElementById("question").src = data[index].flag_r;
